...
public class Build {
    ...
    public static final String CYANOGENMOD_VERSION = getString("ro.aokp.version");

    /** A build ID string meant for displaying to the user */
    public static final String CYANOGENMOD_DISPLAY_VERSION = getString("ro.aokp.display.version");
    ...
    public static class CM_VERSION {
        ...
        public static final int SDK_INT = SystemProperties.getInt(
                "ro.aokp.build.version.plat.sdk", 0);
    }
